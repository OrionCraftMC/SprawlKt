...
public class AbsoluteLayoutAlignItemsAndJustifyContentCenterAndLeftPositionTest {
  @Test
  public fun absolute_layout_align_items_and_justify_content_center_and_left_position(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"alignItems":"center","justifyContent":"center","size":{"width":{"unit":"Points","value":110},"height":{"unit":"Points","value":100}}},"layout":{"width":110,"height":100,"x":0,"y":0},"children":[{"style":{"positionType":"absolute","size":{"width":{"unit":"Points","value":60},"height":{"unit":"Points","value":40}},"position":{"start":{"unit":"Points","value":5}}},"layout":{"width":60,"height":40,"x":5,"y":30},"children":[]}]}
    ...
    kotlin.test.assertEquals(5.0f, Sprawl.layout(node1).location.x)
