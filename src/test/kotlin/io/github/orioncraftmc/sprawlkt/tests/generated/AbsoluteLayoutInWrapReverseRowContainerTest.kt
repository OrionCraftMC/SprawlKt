...
public class AbsoluteLayoutInWrapReverseRowContainerTest {
  @Test
  public fun absolute_layout_in_wrap_reverse_row_container(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","flexWrap":"wrap-reverse","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"positionType":"absolute","size":{"width":{"unit":"Points","value":20},"height":{"unit":"Points","value":20}}},"layout":{"width":20,"height":20,"x":0,"y":80},"children":[]}]}
