...
public class FlexGrowWithinConstrainedMinColumnTest {
  @Test
  public fun flex_grow_within_constrained_min_column(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","minSize":{"height":{"unit":"Points","value":100}}},"layout":{"width":0,"height":100,"x":0,"y":0},"children":[{"style":{"flexGrow":1},"layout":{"width":0,"height":50,"x":0,"y":0},"children":[]},{"style":{"size":{"height":{"unit":"Points","value":50}}},"layout":{"width":0,"height":50,"x":0,"y":50},"children":[]}]}
