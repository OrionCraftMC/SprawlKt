...
public class MarginAutoTopAndBottomStrechTest {
  @Test
  public fun margin_auto_top_and_bottom_strech(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","alignItems":"stretch","size":{"width":{"unit":"Points","value":200},"height":{"unit":"Points","value":200}}},"layout":{"width":200,"height":200,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}},"margin":{"top":{"unit":"Auto"},"bottom":{"unit":"Auto"}}},"layout":{"width":50,"height":50,"x":0,"y":50},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}}},"layout":{"width":50,"height":50,"x":0,"y":150},"children":[]}]}
    ...
    kotlin.test.assertEquals(150.0f, Sprawl.layout(node2).location.y)
  }
}
