...
public class WrapNodesWithContentSizingMarginCrossTest {
  @Test
  public fun wrap_nodes_with_content_sizing_margin_cross(): Unit {
    val node1 = newNode(
    ...
    kotlin.test.assertEquals(70.0f, Sprawl.layout(node5).size.width)
    kotlin.test.assertEquals(90.0f, Sprawl.layout(node5).size.height)
    ...
    kotlin.test.assertEquals(50.0f, Sprawl.layout(node4).location.y)
