...
public class AbsoluteLayoutStartTopEndBottomTest {
  @Test
  public fun absolute_layout_start_top_end_bottom(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"positionType":"absolute","position":{"start":{"unit":"Points","value":10},"end":{"unit":"Points","value":10},"top":{"unit":"Points","value":10},"bottom":{"unit":"Points","value":10}}},"layout":{"width":80,"height":80,"x":10,"y":10},"children":[]}]}
