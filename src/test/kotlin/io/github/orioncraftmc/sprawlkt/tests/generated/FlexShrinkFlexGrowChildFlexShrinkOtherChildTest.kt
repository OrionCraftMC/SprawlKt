...
public class FlexShrinkFlexGrowChildFlexShrinkOtherChildTest {
  @Test
  public fun flex_shrink_flex_grow_child_flex_shrink_other_child(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","size":{"width":{"unit":"Points","value":500},"height":{"unit":"Points","value":500}}},"layout":{"width":500,"height":500,"x":0,"y":0},"children":[{"style":{"flexGrow":0,"flexShrink":1,"size":{"width":{"unit":"Points","value":500},"height":{"unit":"Points","value":100}}},"layout":{"width":250,"height":100,"x":0,"y":0},"children":[]},{"style":{"flexGrow":1,"flexShrink":1,"size":{"width":{"unit":"Points","value":500},"height":{"unit":"Points","value":100}}},"layout":{"width":250,"height":100,"x":250,"y":0},"children":[]}]}
    ...
    kotlin.test.assertEquals(250.0f, Sprawl.layout(node1).size.width)
    ...
    kotlin.test.assertEquals(250.0f, Sprawl.layout(node2).size.width)
