...
public class JustifyContentMinWidthWithPaddingChildWidthGreaterThanParentTest {
  @Test
  public fun justify_content_min_width_with_padding_child_width_greater_than_parent(): Unit {
    val node1 = newNode(
    ...
    val rootNode = newNode(
        ...
        (
        	...
        	size = io.github.orioncraftmc.sprawlkt.geometry.Size(
              width = StretchDimension.Points(1000.0f),
              height = StretchDimension.Points(1584.0f),
           ),
        ),
            listOf(node3),
        )
    // {"style":{"flexDirection":"column","alignContent":"stretch","size":{"width":{"unit":"Points","value":1000},"height":{"unit":"Points","value":1584}}},"layout":{"width":1000,"height":1584,"x":0,"y":0},"children":[{"style":{"flexDirection":"row","alignContent":"stretch"},"layout":{"width":1000,"height":100,"x":0,"y":0},"children":[{"style":{"flexDirection":"row","alignContent":"stretch","justifyContent":"center","minSize":{"width":{"unit":"Points","value":400}},"padding":{"start":{"unit":"Points","value":100},"end":{"unit":"Points","value":100}}},"layout":{"width":500,"height":100,"x":0,"y":0},"children":[{"style":{"flexDirection":"row","alignContent":"stretch","size":{"width":{"unit":"Points","value":300},"height":{"unit":"Points","value":100}}},"layout":{"width":300,"height":100,"x":100,"y":0},"children":[]}]}]}]}
    Sprawl.computeLayout(rootNode, Size.Companion.undefinedNumber())
    kotlin.test.assertEquals(1000.0f, Sprawl.layout(rootNode).size.width)
    kotlin.test.assertEquals(1584.0f, Sprawl.layout(rootNode).size.height)
    kotlin.test.assertEquals(0.0f, Sprawl.layout(rootNode).location.x)
    kotlin.test.assertEquals(0.0f, Sprawl.layout(rootNode).location.y)
    kotlin.test.assertEquals(1000.0f, Sprawl.layout(node3).size.width)
    ...
    kotlin.test.assertEquals(500.0f, Sprawl.layout(node2).size.width)
    ...
    kotlin.test.assertEquals(300.0f, Sprawl.layout(node1).size.width)
