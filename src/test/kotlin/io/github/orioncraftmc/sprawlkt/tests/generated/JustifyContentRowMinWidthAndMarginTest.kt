...
public class JustifyContentRowMinWidthAndMarginTest {
  @Test
  public fun justify_content_row_min_width_and_margin(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","justifyContent":"center","minSize":{"width":{"unit":"Points","value":50}}},"layout":{"width":50,"height":20,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":20},"height":{"unit":"Points","value":20}},"margin":{"start":{"unit":"Points","value":10}}},"layout":{"width":20,"height":20,"x":20,"y":0},"children":[]}]}
