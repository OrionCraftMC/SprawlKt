...
public class RoundingFlexBasisFlexGrowRowWidthOf100Test {
  @Test
  public fun rounding_flex_basis_flex_grow_row_width_of_100(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"flexGrow":1},"layout":{"width":33,"height":100,"x":0,"y":0},"children":[]},{"style":{"flexGrow":1},"layout":{"width":33,"height":100,"x":33,"y":0},"children":[]},{"style":{"flexGrow":1},"layout":{"width":33,"height":100,"x":67,"y":0},"children":[]}]}
    ...
    kotlin.test.assertEquals(33.0f, Sprawl.layout(node1).size.width)
    ...
    kotlin.test.assertEquals(33.0f, Sprawl.layout(node2).location.x)
    ...
    kotlin.test.assertEquals(67.0f, Sprawl.layout(node3).location.x)
