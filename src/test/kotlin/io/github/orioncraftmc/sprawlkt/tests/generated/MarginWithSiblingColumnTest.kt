...
public class MarginWithSiblingColumnTest {
  @Test
  public fun margin_with_sibling_column(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"flexGrow":1,"margin":{"bottom":{"unit":"Points","value":10}}},"layout":{"width":100,"height":45,"x":0,"y":0},"children":[]},{"style":{"flexGrow":1},"layout":{"width":100,"height":45,"x":0,"y":55},"children":[]}]}
    ...
    kotlin.test.assertEquals(45.0f, Sprawl.layout(node1).size.height)
    ...
    kotlin.test.assertEquals(45.0f, Sprawl.layout(node2).size.height)
    kotlin.test.assertEquals(0.0f, Sprawl.layout(node2).location.x)
    kotlin.test.assertEquals(55.0f, Sprawl.layout(node2).location.y)
  }
}
