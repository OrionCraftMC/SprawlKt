...
public class FlexBasisSlightlySmallerThenContentWithFlexGrowLargeSizeTest {
  @Test
  public fun flex_basis_slightly_smaller_then_content_with_flex_grow_large_size(): Unit {
    val node1 = newNode(
    ...
    val node2 = newNode(
        ...
        (
        	...
        	flexGrow = 1.0f,
        	flexBasis = StretchDimension.Points(60.0f),
        ),
            listOf(node1),
        )
    val node3 = newNode(
    ...
    // {"style":{"flexDirection":"row","size":{"width":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"flexDirection":"column","flexGrow":1,"flexBasis":{"unit":"Points","value":60}},"layout":{"width":80,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":70},"height":{"unit":"Points","value":100}}},"layout":{"width":70,"height":100,"x":0,"y":0},"children":[]}]},{"style":{"flexDirection":"column","flexGrow":1,"flexBasis":{"unit":"Points","value":0}},"layout":{"width":20,"height":100,"x":80,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":20},"height":{"unit":"Points","value":100}}},"layout":{"width":20,"height":100,"x":0,"y":0},"children":[]}]}]}
    ...
    kotlin.test.assertEquals(20.0f, Sprawl.layout(node4).size.width)
    kotlin.test.assertEquals(100.0f, Sprawl.layout(node4).size.height)
    kotlin.test.assertEquals(80.0f, Sprawl.layout(node4).location.x)
