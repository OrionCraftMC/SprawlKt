...
public class SizeDefinedByChildWithPaddingTest {
  @Test
  public fun size_defined_by_child_with_padding(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"padding":{"start":{"unit":"Points","value":10},"end":{"unit":"Points","value":10},"top":{"unit":"Points","value":10},"bottom":{"unit":"Points","value":10}}},"layout":{"width":30,"height":30,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":10},"height":{"unit":"Points","value":10}}},"layout":{"width":10,"height":10,"x":10,"y":10},"children":[]}]}
