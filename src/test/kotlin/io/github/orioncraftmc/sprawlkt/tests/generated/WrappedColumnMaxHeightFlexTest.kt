...
public class WrappedColumnMaxHeightFlexTest {
  @Test
  public fun wrapped_column_max_height_flex(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","flexWrap":"wrap","alignItems":"center","alignContent":"center","justifyContent":"center","size":{"width":{"unit":"Points","value":700},"height":{"unit":"Points","value":500}}},"layout":{"width":700,"height":500,"x":0,"y":0},"children":[{"style":{"flexGrow":1,"flexShrink":1,"flexBasis":{"unit":"Percent","value":0},"size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":500}},"maxSize":{"height":{"unit":"Points","value":200}}},"layout":{"width":100,"height":180,"x":300,"y":0},"children":[]},{"style":{"flexGrow":1,"flexShrink":1,"flexBasis":{"unit":"Percent","value":0},"size":{"width":{"unit":"Points","value":200},"height":{"unit":"Points","value":200}},"margin":{"start":{"unit":"Points","value":20},"end":{"unit":"Points","value":20},"top":{"unit":"Points","value":20},"bottom":{"unit":"Points","value":20}}},"layout":{"width":200,"height":180,"x":250,"y":200},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":300,"y":400},"children":[]}]}
    ...
    kotlin.test.assertEquals(300.0f, Sprawl.layout(node1).location.x)
    ...
    kotlin.test.assertEquals(180.0f, Sprawl.layout(node2).size.height)
    kotlin.test.assertEquals(250.0f, Sprawl.layout(node2).location.x)
    kotlin.test.assertEquals(200.0f, Sprawl.layout(node2).location.y)
    ...
    kotlin.test.assertEquals(300.0f, Sprawl.layout(node3).location.x)
    kotlin.test.assertEquals(400.0f, Sprawl.layout(node3).location.y)
  }
}
