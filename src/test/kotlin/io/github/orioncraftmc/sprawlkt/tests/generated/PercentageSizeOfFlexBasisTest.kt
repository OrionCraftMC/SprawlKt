...
public class PercentageSizeOfFlexBasisTest {
  @Test
  public fun percentage_size_of_flex_basis(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","size":{"width":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"flexBasis":{"unit":"Points","value":50}},"layout":{"width":50,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Percent","value":1},"height":{"unit":"Points","value":100}}},"layout":{"width":50,"height":100,"x":0,"y":0},"children":[]}]}]}
