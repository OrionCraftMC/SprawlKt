...
public class JustifyContentRowFlexEndTest {
  @Test
  public fun justify_content_row_flex_end(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","justifyContent":"flex-end","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":10}}},"layout":{"width":10,"height":100,"x":70,"y":0},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":10}}},"layout":{"width":10,"height":100,"x":80,"y":0},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":10}}},"layout":{"width":10,"height":100,"x":90,"y":0},"children":[]}]}
    ...
    kotlin.test.assertEquals(80.0f, Sprawl.layout(node2).location.x)
