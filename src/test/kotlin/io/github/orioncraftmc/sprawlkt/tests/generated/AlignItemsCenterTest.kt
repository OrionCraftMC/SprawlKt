...
public class AlignItemsCenterTest {
  @Test
  public fun align_items_center(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"alignItems":"center","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":10},"height":{"unit":"Points","value":10}}},"layout":{"width":10,"height":10,"x":0,"y":45},"children":[]}]}
    ...
    kotlin.test.assertEquals(45.0f, Sprawl.layout(node1).location.y)
  }
}
