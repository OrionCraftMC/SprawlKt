...
public class JustifyContentColumnFlexEndTest {
  @Test
  public fun justify_content_column_flex_end(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","justifyContent":"flex-end","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"height":{"unit":"Points","value":10}}},"layout":{"width":100,"height":10,"x":0,"y":70},"children":[]},{"style":{"size":{"height":{"unit":"Points","value":10}}},"layout":{"width":100,"height":10,"x":0,"y":80},"children":[]},{"style":{"size":{"height":{"unit":"Points","value":10}}},"layout":{"width":100,"height":10,"x":0,"y":90},"children":[]}]}
    ...
    kotlin.test.assertEquals(90.0f, Sprawl.layout(node3).location.y)
  }
}
