...
public class FlexGrowRootMinimizedTest {
  @Test
  public fun flex_grow_root_minimized(): Unit {
    val node1 = newNode(
            io.github.orioncraftmc.sprawlkt.style.Style
        (
        	flexGrow = 1.0f,
        	flexBasis = StretchDimension.Points(200.0f),
        ),
            listOf(),
        )
    val node2 = newNode(
    ...
    // {"style":{"flexDirection":"column","size":{"width":{"unit":"Points","value":100}},"minSize":{"height":{"unit":"Points","value":100}},"maxSize":{"height":{"unit":"Points","value":500}}},"layout":{"width":100,"height":300,"x":0,"y":0},"children":[{"style":{"flexDirection":"column","flexGrow":1,"minSize":{"height":{"unit":"Points","value":100}},"maxSize":{"height":{"unit":"Points","value":500}}},"layout":{"width":100,"height":300,"x":0,"y":0},"children":[{"style":{"flexGrow":1,"flexBasis":{"unit":"Points","value":200}},"layout":{"width":100,"height":200,"x":0,"y":0},"children":[]},{"style":{"size":{"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":200},"children":[]}]}]}
    Sprawl.computeLayout(rootNode, Size.Companion.undefinedNumber())
    kotlin.test.assertEquals(100.0f, Sprawl.layout(rootNode).size.width)
    kotlin.test.assertEquals(300.0f, Sprawl.layout(rootNode).size.height)
    kotlin.test.assertEquals(0.0f, Sprawl.layout(rootNode).location.x)
    kotlin.test.assertEquals(0.0f, Sprawl.layout(rootNode).location.y)
    kotlin.test.assertEquals(100.0f, Sprawl.layout(node3).size.width)
    kotlin.test.assertEquals(300.0f, Sprawl.layout(node3).size.height)
