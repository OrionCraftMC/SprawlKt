...
public class AlignItemsCenterChildWithoutMarginBiggerThanParentTest {
  @Test
  public fun align_items_center_child_without_margin_bigger_than_parent(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"alignItems":"center","justifyContent":"center","size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}}},"layout":{"width":50,"height":50,"x":0,"y":0},"children":[{"style":{"alignItems":"center"},"layout":{"width":70,"height":70,"x":-10,"y":-10},"children":[{"style":{"size":{"width":{"unit":"Points","value":70},"height":{"unit":"Points","value":70}}},"layout":{"width":70,"height":70,"x":0,"y":0},"children":[]}]}]}
