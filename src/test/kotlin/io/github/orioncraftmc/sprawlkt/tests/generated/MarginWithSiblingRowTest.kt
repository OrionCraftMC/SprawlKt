...
public class MarginWithSiblingRowTest {
  @Test
  public fun margin_with_sibling_row(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"flexGrow":1,"margin":{"end":{"unit":"Points","value":10}}},"layout":{"width":45,"height":100,"x":0,"y":0},"children":[]},{"style":{"flexGrow":1},"layout":{"width":45,"height":100,"x":55,"y":0},"children":[]}]}
    ...
    kotlin.test.assertEquals(45.0f, Sprawl.layout(node1).size.width)
    ...
    kotlin.test.assertEquals(45.0f, Sprawl.layout(node2).size.width)
    kotlin.test.assertEquals(100.0f, Sprawl.layout(node2).size.height)
    kotlin.test.assertEquals(55.0f, Sprawl.layout(node2).location.x)
