...
public class FlexBasisFlexGrowRowTest {
  @Test
  public fun flex_basis_flex_grow_row(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"flexGrow":1,"flexBasis":{"unit":"Points","value":50}},"layout":{"width":75,"height":100,"x":0,"y":0},"children":[]},{"style":{"flexGrow":1},"layout":{"width":25,"height":100,"x":75,"y":0},"children":[]}]}
    ...
    kotlin.test.assertEquals(75.0f, Sprawl.layout(node1).size.width)
