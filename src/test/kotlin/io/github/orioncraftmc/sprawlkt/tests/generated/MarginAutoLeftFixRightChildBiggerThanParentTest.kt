...
public class MarginAutoLeftFixRightChildBiggerThanParentTest {
  @Test
  public fun margin_auto_left_fix_right_child_bigger_than_parent(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"justifyContent":"center","size":{"width":{"unit":"Points","value":52},"height":{"unit":"Points","value":52}}},"layout":{"width":52,"height":52,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":72},"height":{"unit":"Points","value":72}},"margin":{"start":{"unit":"Auto"},"end":{"unit":"Points","value":10}}},"layout":{"width":42,"height":72,"x":0,"y":0},"children":[]}]}
