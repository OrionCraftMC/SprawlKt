...
public class MarginAutoMutipleChildrenRowTest {
  @Test
  public fun margin_auto_mutiple_children_row(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","alignItems":"center","size":{"width":{"unit":"Points","value":200},"height":{"unit":"Points","value":200}}},"layout":{"width":200,"height":200,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}},"margin":{"end":{"unit":"Auto"}}},"layout":{"width":50,"height":50,"x":0,"y":75},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}},"margin":{"end":{"unit":"Auto"}}},"layout":{"width":50,"height":50,"x":75,"y":75},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}}},"layout":{"width":50,"height":50,"x":150,"y":75},"children":[]}]}
    ...
    kotlin.test.assertEquals(75.0f, Sprawl.layout(node1).location.y)
    ...
    kotlin.test.assertEquals(150.0f, Sprawl.layout(node3).location.x)
    kotlin.test.assertEquals(75.0f, Sprawl.layout(node3).location.y)
  }
}
