...
public class JustifyContentRowSpaceAroundTest {
  @Test
  public fun justify_content_row_space_around(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"row","justifyContent":"space-around","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":10}}},"layout":{"width":10,"height":100,"x":12,"y":0},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":10}}},"layout":{"width":10,"height":100,"x":45,"y":0},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":10}}},"layout":{"width":10,"height":100,"x":78,"y":0},"children":[]}]}
    ...
    kotlin.test.assertEquals(12.0f, Sprawl.layout(node1).location.x)
    ...
    kotlin.test.assertEquals(78.0f, Sprawl.layout(node3).location.x)
