...
public class JustifyContentColumnSpaceEvenlyTest {
  @Test
  public fun justify_content_column_space_evenly(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","justifyContent":"space-evenly","size":{"width":{"unit":"Points","value":100},"height":{"unit":"Points","value":100}}},"layout":{"width":100,"height":100,"x":0,"y":0},"children":[{"style":{"size":{"height":{"unit":"Points","value":10}}},"layout":{"width":100,"height":10,"x":0,"y":18},"children":[]},{"style":{"size":{"height":{"unit":"Points","value":10}}},"layout":{"width":100,"height":10,"x":0,"y":45},"children":[]},{"style":{"size":{"height":{"unit":"Points","value":10}}},"layout":{"width":100,"height":10,"x":0,"y":73},"children":[]}]}
    ...
    kotlin.test.assertEquals(18.0f, Sprawl.layout(node1).location.y)
    ...
    kotlin.test.assertEquals(73.0f, Sprawl.layout(node3).location.y)
  }
}
