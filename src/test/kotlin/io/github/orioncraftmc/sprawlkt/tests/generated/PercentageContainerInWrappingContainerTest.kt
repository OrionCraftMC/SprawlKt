...
public class PercentageContainerInWrappingContainerTest {
  @Test
  public fun percentage_container_in_wrapping_container(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","alignItems":"center","justifyContent":"center","size":{"width":{"unit":"Points","value":200},"height":{"unit":"Points","value":200}}},"layout":{"width":200,"height":200,"x":0,"y":0},"children":[{"style":{"flexDirection":"column"},"layout":{"width":100,"height":50,"x":50,"y":75},"children":[{"style":{"flexDirection":"row","justifyContent":"center","size":{"width":{"unit":"Percent","value":1}}},"layout":{"width":100,"height":50,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}}},"layout":{"width":50,"height":50,"x":0,"y":0},"children":[]},{"style":{"size":{"width":{"unit":"Points","value":50},"height":{"unit":"Points","value":50}}},"layout":{"width":50,"height":50,"x":50,"y":0},"children":[]}]}]}]}
    ...
    kotlin.test.assertEquals(75.0f, Sprawl.layout(node4).location.y)
