...
public class JustifyContentColumnMinHeightAndMarginTopTest {
  @Test
  public fun justify_content_column_min_height_and_margin_top(): Unit {
    val node1 = newNode(
    ...
    // {"style":{"flexDirection":"column","justifyContent":"center","minSize":{"height":{"unit":"Points","value":50}}},"layout":{"width":20,"height":50,"x":0,"y":0},"children":[{"style":{"size":{"width":{"unit":"Points","value":20},"height":{"unit":"Points","value":20}},"margin":{"top":{"unit":"Points","value":10}}},"layout":{"width":20,"height":20,"x":0,"y":20},"children":[]}]}
